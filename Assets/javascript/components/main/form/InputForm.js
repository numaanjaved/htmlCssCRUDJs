...
let formProfilePicContainer = createNewElement([
  "div",
  "form_profile_picture_container",
  form,
]);
let imgInputContainer = createNewElement([
  "div",
  "image_input",
...
let profilePictureDisplayContainer = createNewElement([
  "div",
  "profile_picture_display_container",
  formProfilePicContainer,
]);
createNewElement([
  "img",
