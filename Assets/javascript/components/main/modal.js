let modal = (profilePic, userName, userEmail, userContactNum, userAddress, userBio, id = null
  ...
  let modalPictureContainer = createNewElement([
    "div",
    "modal_picture_container",
    modalContentContainer,
  ]);
  let modalPicFigureTag = createNewElement([
    "figure",
    "profile_figure_tag",
  ...
  let modalTextContainer = createNewElement([
    "div",
    "modal_text_content_container",
    modalContentContainer,
  ]);
  createNewElement([
    "p",
  ...
  let modalCloseBtn = createNewElement([
    "button",
    "modal_close_btn",
    modalContentContainer,
    `Close`,
